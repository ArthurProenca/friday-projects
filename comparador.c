...
int main()
{
    int n, *vector = 0, *vector2 = 0, *vectorAux = 0, i, j, opt, aux, counter = 0, counterS = 0, counterI = 0, min;
    ...
    vectorAux = (int *)malloc(sizeof(int *) * n);
    ...
    system("clear"); //Using Windows, run system("cls");
    free(vector);
    free(vector2);
    free(vectorAux);
